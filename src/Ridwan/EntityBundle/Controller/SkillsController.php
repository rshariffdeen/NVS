...
class SkillsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RidwanEntityBundle:Skills')->findAll();
     ...
     *
     * @Route("/", name="skills_create")
     * @Method("POST")
     * @Template("RidwanEntityBundle:Skills:new.html.twig")
     */
    ...
    private function createCreateForm(Skills $entity)
    {
        $form = $this->createForm(new SkillsType(), $entity, array(
            'action' => $this->generateUrl('skills_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RidwanEntityBundle:Skills')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new SkillsType(), $entity, array(
            'action' => $this->generateUrl('skills_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="skills_update")
     * @Method("PUT")
     * @Template("RidwanEntityBundle:Skills:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('skills_delete', array('id' => $id)))
            ->setMethod('DELETE')
