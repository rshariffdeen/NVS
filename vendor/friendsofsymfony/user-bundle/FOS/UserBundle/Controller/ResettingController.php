...
class ResettingController extends ContainerAware
{
    ...
    public function requestAction()
    {
        ...
        return new RedirectResponse($this->container->get('router')->generate('ridwan_site_loginpage'));
    }
    ...
    public function sendEmailAction()
    {
        ...
        if (null === $user) {
          ...
          return new RedirectResponse($this->container->get('router')->generate('ridwan_site_loginpage',array('type' =>'E','message'=>'Invalid Username')));
        }
